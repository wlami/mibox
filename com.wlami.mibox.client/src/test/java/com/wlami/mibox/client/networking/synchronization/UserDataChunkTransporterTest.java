...
public class UserDataChunkTransporterTest {
	...
	// * Test method for
	// * {@link
	// com.wlami.mibox.client.networking.synchronization.TransportWorkerUserData#encryptAndUploadChunk(com.wlami.mibox.client.metadata.MChunk)}
	// * .
	// *
	// * @throws IOException
	...
	// */
	// @Test
	// public void testEncryptAndUploadChunk() throws CryptoException,
	// IOException {
	...
	// * Test method for
	// * {@link
	// com.wlami.mibox.client.networking.synchronization.TransportWorkerUserData#downloadAndDecryptChunk(com.wlami.mibox.client.metadata.MChunk)}
	// * .
	// *
	// * @throws IOException
	// * @throws CryptoException
