...
public interface ChunkManagerResponseBuilder {
	...
	/**
	 * Builds a {@link Response} for a put request.
	 * 
	 * @param hash
	 *            Hash of the chunk.
	 * @param inputStream
	 *            This stream is a reference to the chunk data. May be
	 *            unnecessary in case of redirection.
	 * @return An HTTP-{@link Response}. The HTTP status can differ: If
	 *         successful 200 (ok) or 3xx (in case of redirection). Otherwise >=
	 *         400
	 */
	public abstract Response buildPutChunkResponse(String hash,
